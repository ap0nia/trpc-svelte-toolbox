...
import { createRootHooks as createHooksInternal, } from './shared/hooks/createHooksInternal';
import type { CreateSvelteQueryHooks, } from './shared/hooks/createHooksInternal';
import type {
  CreateClient,
...
export function createHooksInternalProxy<
  ...
  TSSRContext = unknown,
  TFlags = null,
>(trpc: CreateSvelteQueryHooks<TRouter, TSSRContext>) {
  type CreateHooksInternalProxy = CreateTRPCSvelte<TRouter, TSSRContext, TFlags>;
...
export function createTRPCSvelte<
  TRouter extends AnyRouter,
  TSSRContext = unknown,
  TFlags = null,
>(
  opts?: CreateTRPCReactOptions<TRouter>,
): CreateTRPCSvelte<TRouter, TSSRContext, TFlags> {
