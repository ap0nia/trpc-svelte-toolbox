...
[See how to use the hooks in SvelteKit load functions here](/docs/sveltekit/setup).
:::
...
which [they document in more depth here](https://tanstack.com/query/latest/docs/svelte/overview#example).
