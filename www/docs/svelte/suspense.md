...
- If you use suspense with [tRPC's _automatic_ SSR in Next.js](/docs/svelte/setup), the full page will crash on the server if a query fails, even if you have an `<ErrorBoundary />`
