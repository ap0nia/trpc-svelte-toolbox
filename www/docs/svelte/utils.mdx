...
:::info
We have prefixed this as `unstable_` as it's a new API, but you're safe to use it! [Read more](/docs/svelte/setup).
:::
...
We have **NOT** added a feature to help with this:
