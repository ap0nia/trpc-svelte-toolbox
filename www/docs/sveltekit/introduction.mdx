...
:::tip
If you are using Next.js we recommend using [our integration with that](/docs/sveltekit/introduction) instead
:::
...
- Query Keys - these are generated and managed by tRPC on your behalf, based on the procedure inputs you provide
  - If you need the query key which tRPC calculates, you can use [getQueryKey](/docs/svelte/getquerykey)
